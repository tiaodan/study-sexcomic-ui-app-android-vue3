...
<template>
	<div style="display: flex; flex-direction: column; height: calc(100vh - var(--safe-area-inset-top) - var(--safe-area-inset-bottom) - var(--vant-footbar-height) - var(--vant-tab-height-line) );  ">
		<!-- 注释：顶部分类标签 -->
		<div >
...
// 导入自己写的
import  ComicGrid from '@/components/comic/public/grid/ComicGrid3Col.vue';  // 不能带中括号
