...
// 控制顶部导航栏显示隐藏
const showNavBar = ref(false)  // 默认隐藏
const toggleNavBar = () => {
  showNavBar.value = !showNavBar.value
  // console.log("点击了图片, 顶部导航栏显示状态 showNavBar : ", showNavBar.value)
}
const goBack = () => {
  // 返回上一页
...
.class-image-list {
  ...
  // ✅ 防止 img 之间出现 1px 间隙 -- 这个其实是最有效的。
  // 表示行间距。1 填文字大小倍数，如1.5 3，2- 填像素 px， 
  // 只有line-height 对于 无缝衔接最有效
  line-height: 0;  
